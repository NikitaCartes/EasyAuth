...
public class LangConfigV1 extends ConfigTemplate {
    ...
    public TranslatableText otpProhibited = new TranslatableText("text.easyauth.otpProhibited", "§4You cannot enable OTP login.");
    public TranslatableText otpGenerated = new TranslatableText("text.easyauth.otpGenerated", "§aTo enable OTP login, enter /account otp enable <code>, where code is the OTP generated by your OTP application using the following key:");
    public TranslatableText otpEnabled = new TranslatableText("text.easyauth.otpEnabled", "§aOTP login successfully enabled.");
    public TranslatableText otpSecretNotGenerated = new TranslatableText("text.easyauth.otpSecretNotGenerated", "§4The OTP key was not generated. Execute the command /account otp enable");
    public TranslatableText otpEnableFailed = new TranslatableText("text.easyauth.otpEnableFailed", "§4Incorrect OTP!\n§6Try again by entering /account otp enable");
    public TranslatableText otpAlreadyEnabled = new TranslatableText("text.easyauth.otpAlreadyEnabled", "§4OTP login is already enabled.");
    public TranslatableText otpDisabled = new TranslatableText("text.easyauth.otpDisabled", "§aOTP login successfully disabled.");
    public TranslatableText otpAlreadyDisabled = new TranslatableText("text.easyauth.otpAlreadyDisabled", "§4OTP login is already disabled.");
    public TranslatableText twoFactorAuthEnabled = new TranslatableText("text.easyauth.twoFactorAuthEnabled", "§aTwo-factor authentication successfully enabled.");
    public TranslatableText twoFactorAuthEnableFailed = new TranslatableText("text.easyauth.twoFactorAuthEnableFailed", "§4Error enabling two-factor authentication.");
    public TranslatableText twoFactorAuthAlreadyEnabled = new TranslatableText("text.easyauth.twoFactorAuthAlreadyEnabled", "§4Two-factor authentication is already enabled.");
    public TranslatableText twoFactorAuthDisabled = new TranslatableText("text.easyauth.twoFactorAuthDisabled", "§aTwo-factor authentication successfully disabled.");
    public TranslatableText twoFactorAuthAlreadyDisabled = new TranslatableText("text.easyauth.twoFactorAuthAlreadyDisabled", "§4Two-factor authentication is already disabled.");
    public TranslatableText twoFactorAuthDisableFailed = new TranslatableText("text.easyauth.twoFactorAuthDisableFailed", "§4Error disabling two-factor authentication.");
    public TranslatableText wrongOtp = new TranslatableText("text.easyauth.wrongOtp", "§4Incorrect OTP!");
    public TranslatableText otpReset = new TranslatableText("text.easyauth.otpReset", "§aOTP key reset successfully for %s.");
    public TranslatableText enterPasswordWithOtp = new TranslatableText("text.easyauth.enterPasswordWithOtp", "§6If you've enabled 2FA, you need to enter your password and OTP, otherwise just your password/OTP");
    public TranslatableText otpNotEnabled = new TranslatableText("text.easyauth.otpNotEnabled", "§6OTP login is not enabled. Enter /account otp enable to enable it.");
    public TranslatableText otpRequired = new TranslatableText("text.easyauth.otpRequired", "§6You need to enter your OTP to login.");
    public TranslatableText passwordIsNotRequired = new TranslatableText("text.easyauth.passwordIsNotRequired", "§6You don't need to enter your password to login.");
    ...
    protected String handleTemplate() throws IOException {
        ...
        configValues.put("otpProhibited", wrapIfNecessary(otpProhibited));
        configValues.put("otpGenerated", wrapIfNecessary(otpGenerated));
        configValues.put("otpEnabled", wrapIfNecessary(otpEnabled));
        configValues.put("otpSecretNotGenerated", wrapIfNecessary(otpSecretNotGenerated));
        configValues.put("otpEnableFailed", wrapIfNecessary(otpEnableFailed));
        configValues.put("otpAlreadyEnabled", wrapIfNecessary(otpAlreadyEnabled));
        configValues.put("otpDisabled", wrapIfNecessary(otpDisabled));
        configValues.put("otpAlreadyDisabled", wrapIfNecessary(otpAlreadyDisabled));
        configValues.put("twoFactorAuthEnabled", wrapIfNecessary(twoFactorAuthEnabled));
        configValues.put("twoFactorAuthEnableFailed", wrapIfNecessary(twoFactorAuthEnableFailed));
        configValues.put("twoFactorAuthAlreadyEnabled", wrapIfNecessary(twoFactorAuthAlreadyEnabled));
        configValues.put("twoFactorAuthDisabled", wrapIfNecessary(twoFactorAuthDisabled));
        configValues.put("twoFactorAuthAlreadyDisabled", wrapIfNecessary(twoFactorAuthAlreadyDisabled));
        configValues.put("twoFactorAuthDisableFailed", wrapIfNecessary(twoFactorAuthDisableFailed));
        configValues.put("wrongOtp", wrapIfNecessary(wrongOtp));
        configValues.put("otpReset", wrapIfNecessary(otpReset));
        configValues.put("enterPasswordWithOtp", wrapIfNecessary(enterPasswordWithOtp));
        configValues.put("otpNotEnabled", wrapIfNecessary(otpNotEnabled));
        configValues.put("otpRequired", wrapIfNecessary(otpRequired));
        configValues.put("passwordIsNotRequired", wrapIfNecessary(passwordIsNotRequired));
